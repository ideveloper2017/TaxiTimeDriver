...
import com.taxitime.driver.API.RetrofitClient;
...
import com.taxitime.driver.Models.DocumentResponse;
import com.taxitime.driver.Models.docResposne;
import com.taxitime.driver.Models.document;
...
public class UploadDocument extends AppCompatActivity {
    ...
    private Context context = UploadDocument.this;
    private Uri selectedimage;
    private String _pid="", _did="";
    private ProgressDialog progressDialog;
    private AppCompatButton uploaded;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploaded.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                startActivity(new Intent(UploadDocument.this, WaitingForApproval.class));
        ...
        progressDialog = new ProgressDialog(UploadDocument.this);
        progressDialog.setMessage("Loading....");
        progressDialog.setTitle(R.string.app_name);
        progressDialog.create();
        if(ContextCompat.checkSelfPermission(UploadDocument.this, Manifest.permission.READ_EXTERNAL_STORAGE  )
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ActivityCompat.requestPermissions(UploadDocument.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE
                                }, STORAGE_PERMISSION);
                            }
                        })
    ...
    private void getalldocs() {
        ...
        call.enqueue(new Callback<DocumentResponse>() {
            ...
            public void onResponse(Call<DocumentResponse> call, Response<DocumentResponse> response) {
                ...
                documentlistadapter adapter = new documentlistadapter(UploadDocument.this, documentList);
...
//                    SharedHelper.putKey(context, "payment_mode", response.optString("payment_mode"));
      ...
      //  File newfile = saveBitmapToFile(file);
       ...
       call.enqueue(new Callback<docResposne>() {
           ...
           public void onResponse(Call<docResposne> call, Response<docResposne> response) {
               Toast.makeText(UploadDocument.this, ""+response.body().getMessage(), Toast.LENGTH_SHORT).show();
               getalldocs();
    ...
    private class documentlistadapter extends RecyclerView.Adapter<documentlistadapter.doclistholder>{
        ...
        public doclistholder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(mxtx).inflate(R.layout.recycle_all_documents,parent,false);
