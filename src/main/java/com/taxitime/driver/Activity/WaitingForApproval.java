...
public class WaitingForApproval extends AppCompatActivity {
    Button logoutBtn, resubmitDocBtn;
    public Handler ha;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resubmitDocBtn = findViewById(R.id.resubmitDocBtn);
        ...
        resubmitDocBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(WaitingForApproval.this, UploadDocument.class));
            }
        });
