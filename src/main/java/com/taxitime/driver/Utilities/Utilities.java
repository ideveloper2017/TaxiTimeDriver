package com.taxitime.driver.Utilities;
...
//        boolean status = matcher.matches();
    ...
    public static void notify(Context context, Activity activity){
        ...
        androidx.core.app.NotificationCompat.Builder notificationBuilder = new androidx.core.app.NotificationCompat.Builder(context)
